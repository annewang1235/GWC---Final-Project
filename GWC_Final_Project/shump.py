...
pygame.display.set_caption("Spuffin!")
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.transform.scale(bullet_img, (9, 20))
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.rect.bottom = y
        self.rect.centerx = x
...
def show_go_screen():
    ...
    draw_text(screen, "SPUFFIN!", 64, WIDTH / 2, HEIGHT / 4)
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'las.wav'))
explosion_sound = pygame.mixer.Sound(path.join(snd_dir, 'exp.wav'))
...
while running:
    ...
    for hit in hits:
        ...
        #if player died and hthe explosion has finished playing
